class Worker extends Phaser.GameObjects.Container {
    ...
    init(){
        this.defaultHead = new Phaser.Physics.Arcade.Sprite(this.scene, 0, 0, 'worker1Head').setOrigin(0,0);
        this.defaultBody = new Phaser.Physics.Arcade.Sprite(this.scene, 0, 14, 'worker1Body').setOrigin(0,0);
