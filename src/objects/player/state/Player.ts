...
class Player extends Phaser.GameObjects.Container {
    ...
    init(){
        this.defaultHead = new Phaser.Physics.Arcade.Sprite(this.scene, 2, -8, 'defaultHead').setOrigin(0,0);
        this.defaultBody = new Phaser.Physics.Arcade.Sprite(this.scene, 4, 6, 'defaultBody').setOrigin(0,0);
        this.defaultJetpack = new Phaser.Physics.Arcade.Sprite(this.scene, -8, 0, 'defaultJetpack').setOrigin(0,0);
