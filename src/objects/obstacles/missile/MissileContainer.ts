...
class Missile extends Phaser.GameObjects.Container {
    ...
    public curentState: MissileState;
    ...
    init(){
        this.missile = new Phaser.Physics.Arcade.Sprite(this.scene, 0, -2, 'missile', 0).setOrigin(0, 0);
        this.missileEffect = new Phaser.Physics.Arcade.Sprite(this.scene, 18, -17, 'missileEffect', 0).setOrigin(0, 0);
        this.missileAlert = null;
        this.curentState = MissileState.ALERT;
